    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.crm-customers.update", [$crmCustomer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $crmCustomer->first_name) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('full_name') ? 'is-invalid' : '' }}" name="full_name" id="full_name" required>{{ old('full_name', $crmCustomer->full_name) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_identification') ? 'is-invalid' : '' }}" type="text" name="user_identification" id="user_identification" value="{{ old('user_identification', $crmCustomer->user_identification) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clinic_name') ? 'is-invalid' : '' }}" type="text" name="clinic_name" id="clinic_name" value="{{ old('clinic_name', $crmCustomer->clinic_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $crmCustomer->phone_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('birthday') ? 'is-invalid' : '' }}" type="text" name="birthday" id="birthday" value="{{ old('birthday', $crmCustomer->birthday) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('new_address') ? 'is-invalid' : '' }}" name="new_address" id="new_address">{{ old('new_address', $crmCustomer->new_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('unrwa_clinic') ? 'is-invalid' : '' }}" name="unrwa_clinic" id="unrwa_clinic" required>{{ old('unrwa_clinic', $crmCustomer->unrwa_clinic) }}</textarea>
